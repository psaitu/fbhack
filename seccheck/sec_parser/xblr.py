...
from sec_parser.xbrl_fundamentals import FundamentantalAccountingConcepts
import re
...
class XBRL:
    ...
    def __init__(self,XBRLInstanceLocation):
        ...
        self.oInstance = etree.fromstring(bytes(self.EntireInstanceDocument, encoding='utf-8'))
        self.ns = {}
